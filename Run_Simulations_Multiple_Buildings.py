...
number_of_weeks_for_evaluation = 20
number_of_buildings_for_evaluation = 20
useChronologicalOrderForFirstTestWeek = True
number_of_iterations_ML_method = 1
...
building_index_increment_simulation = 18
...
maximumNumberOfStarts_Combined = 1 * 7
...
if __name__ == "__main__":
    ...
    #Result arrays for the different methods, weeks, and buildings
    result_multiple_buildings_simulationObjective_costs_Euro_ML = np.zeros((number_of_weeks_for_evaluation, number_of_buildings_for_evaluation))
    result_multiple_buildings_negativeScore_CorrectionLimit_ML =  np.zeros((number_of_weeks_for_evaluation, number_of_buildings_for_evaluation))
    result_multiple_buildings_negativeScore_PhysicalLimit_ML =  np.zeros((number_of_weeks_for_evaluation, number_of_buildings_for_evaluation))
    result_multiple_buildings_negativeScore_total_overall_ML =  np.zeros((number_of_weeks_for_evaluation, number_of_buildings_for_evaluation))

    result_multiple_buildings_simulationObjective_costs_Euro_OPT =  np.zeros((number_of_weeks_for_evaluation, number_of_buildings_for_evaluation))
    result_multiple_buildings_negativeScore_CorrectionLimit_OPT =  np.zeros((number_of_weeks_for_evaluation, number_of_buildings_for_evaluation))
    result_multiple_buildings_negativeScore_PhysicalLimit_OPT =  np.zeros((number_of_weeks_for_evaluation, number_of_buildings_for_evaluation))
    result_multiple_buildings_negativeScore_total_overall_OPT =  np.zeros((number_of_weeks_for_evaluation, number_of_buildings_for_evaluation))

    result_multiple_buildings_simulationObjective_costs_Euro_PSC =  np.zeros((number_of_weeks_for_evaluation, number_of_buildings_for_evaluation))
    result_multiple_buildings_negativeScore_CorrectionLimit_PSC =  np.zeros((number_of_weeks_for_evaluation, number_of_buildings_for_evaluation))
    result_multiple_buildings_negativeScore_PhysicalLimit_PSC =  np.zeros((number_of_weeks_for_evaluation, number_of_buildings_for_evaluation))
    result_multiple_buildings_negativeScore_total_overall_PSC =  np.zeros((number_of_weeks_for_evaluation, number_of_buildings_for_evaluation))

    result_multiple_buildings_simulationObjective_costs_Euro_CC =  np.zeros((number_of_weeks_for_evaluation, number_of_buildings_for_evaluation))
    result_multiple_buildings_negativeScore_CorrectionLimit_CC =  np.zeros((number_of_weeks_for_evaluation, number_of_buildings_for_evaluation))
    result_multiple_buildings_negativeScore_PhysicalLimit_CC =  np.zeros((number_of_weeks_for_evaluation, number_of_buildings_for_evaluation))
    result_multiple_buildings_negativeScore_total_overall_CC =  np.zeros((number_of_weeks_for_evaluation, number_of_buildings_for_evaluation))


    for i in range (0, number_of_weeks_for_evaluation):
            ...
            for iteration_ML_method in range (0, number_of_iterations_ML_method):
                ...
                if used_trained_models_in_simulations_supervised_learning == True:
                    ...
                    if SetUpScenarios.numberOfBuildings_BT4 == 1:
                        ...
                        for current_building_index_for_evaluation in range (0, number_of_buildings_for_evaluation):

                            building_index_increment_simulation = current_building_index_for_evaluation
                            print(f"building_index_increment_simulation: {building_index_increment_simulation}")
                            ...
                            indexOfBuildingsOverall_BT4 [0] = current_building_index_for_evaluation + 1
                            ...
                            print(f"outputVectorANN_heatGenerationCoefficientSpaceHeating_BT4: {outputVectorANN_heatGenerationCoefficientSpaceHeating_BT4}")
                            ...
                            result_multiple_buildings_simulationObjective_costs_Euro_ML [currentWeekForChronologicalOrder, current_building_index_for_evaluation] = simulationObjective_costs_Euro_combined
                            result_multiple_buildings_negativeScore_CorrectionLimit_ML [currentWeekForChronologicalOrder, current_building_index_for_evaluation]= negativeScore_total_overall
                            result_multiple_buildings_negativeScore_PhysicalLimit_ML [currentWeekForChronologicalOrder, current_building_index_for_evaluation]= negativeScore_CorrectionLimit
                            result_multiple_buildings_negativeScore_total_overall_ML [currentWeekForChronologicalOrder, current_building_index_for_evaluation]= negativeScore_PhysicalLimit
                            print(f"current_building_index_for_evaluation: {current_building_index_for_evaluation}")
                            print(f"simulationObjective_costs_Euro_combined: {simulationObjective_costs_Euro_combined}")
                            print(f"result_multiple_buildings_simulationObjective_costs_Euro {result_multiple_buildings_simulationObjective_costs_Euro_ML}")
                            print(f"result_multiple_buildings_negativeScore_CorrectionLimit {result_multiple_buildings_negativeScore_CorrectionLimit_ML}")
                            print(f"result_multiple_buildings_negativeScore_PhysicalLimit {result_multiple_buildings_negativeScore_PhysicalLimit_ML}")
                            print(f"result_multiple_buildings_negativeScore_total_overall {result_multiple_buildings_negativeScore_total_overall_ML}")
        ...
        if useCentralizedOptimization == True:
            ...
            for current_building_index_for_evaluation in range(0, 20):
                building_index_increment_simulation = current_building_index_for_evaluation
                print(f"building_index_increment_simulation: {building_index_increment_simulation}")
                ...
                result_multiple_buildings_simulationObjective_costs_Euro_OPT [currentWeekForChronologicalOrder, current_building_index_for_evaluation]= simulationObjective_costs_Euro_combined
                result_multiple_buildings_negativeScore_CorrectionLimit_OPT [currentWeekForChronologicalOrder, current_building_index_for_evaluation]= negativeScore_total_overall
                result_multiple_buildings_negativeScore_PhysicalLimit_OPT [currentWeekForChronologicalOrder, current_building_index_for_evaluation]= negativeScore_CorrectionLimit
                result_multiple_buildings_negativeScore_total_overall_OPT [currentWeekForChronologicalOrder, current_building_index_for_evaluation]= negativeScore_PhysicalLimit
                print(f"current_building_index_for_evaluation_OPT: {current_building_index_for_evaluation}")
                print(f"simulationObjective_costs_Euro_combined_OPT: {simulationObjective_costs_Euro_combined}")
                print(f"result_multiple_buildings_simulationObjective_costs_Euro_OPT {result_multiple_buildings_simulationObjective_costs_Euro_OPT}")
                print(f"result_multiple_buildings_negativeScore_CorrectionLimit_OPT {result_multiple_buildings_negativeScore_CorrectionLimit_OPT}")
                print(f"result_multiple_buildings_negativeScore_PhysicalLimit_OPT {result_multiple_buildings_negativeScore_PhysicalLimit_OPT}")
                print(f"result_multiple_buildings_negativeScore_total_overall_OPT {result_multiple_buildings_negativeScore_total_overall_OPT}")
        ...
        if usePriceStorageControl_BT4 ==True:
            ...
            #negativScoreTotal_PriceStorageControl_PhysicalLimit = negativeScore_PhysicalLimit
                result_multiple_buildings_simulationObjective_costs_Euro_PSC [currentWeekForChronologicalOrder, current_building_index_for_evaluation]= simulationObjective_costs_Euro_combined
                result_multiple_buildings_negativeScore_CorrectionLimit_PSC [currentWeekForChronologicalOrder, current_building_index_for_evaluation]= negativeScore_total_overall
                result_multiple_buildings_negativeScore_PhysicalLimit_PSC [currentWeekForChronologicalOrder, current_building_index_for_evaluation]= negativeScore_CorrectionLimit
                result_multiple_buildings_negativeScore_total_overall_PSC [currentWeekForChronologicalOrder, current_building_index_for_evaluation]= negativeScore_PhysicalLimit
                print(f"current_building_index_for_evaluation_PSC: {current_building_index_for_evaluation}")
                print(f"simulationObjective_costs_Euro_combined_PSC: {simulationObjective_costs_Euro_combined}")
                print(f"result_multiple_buildings_simulationObjective_costs_Euro_PSC {result_multiple_buildings_simulationObjective_costs_Euro_PSC}")
                print(f"result_multiple_buildings_negativeScore_CorrectionLimit_PSC {result_multiple_buildings_negativeScore_CorrectionLimit_PSC}")
                print(f"result_multiple_buildings_negativeScore_PhysicalLimit_PSC {result_multiple_buildings_negativeScore_PhysicalLimit_PSC}")
                print(f"result_multiple_buildings_negativeScore_total_overall_PSC {result_multiple_buildings_negativeScore_total_overall_PSC}")
        ...
        if useConventionalControl == True:
            ...
            for current_building_index_for_evaluation in range (0, 20):
                ...
                result_multiple_buildings_simulationObjective_costs_Euro_CC [currentWeekForChronologicalOrder, current_building_index_for_evaluation]= simulationObjective_costs_Euro_combined
                result_multiple_buildings_negativeScore_CorrectionLimit_CC [currentWeekForChronologicalOrder, current_building_index_for_evaluation]= negativeScore_total_overall
                result_multiple_buildings_negativeScore_PhysicalLimit_CC [currentWeekForChronologicalOrder, current_building_index_for_evaluation]= negativeScore_CorrectionLimit
                result_multiple_buildings_negativeScore_total_overall_CC [currentWeekForChronologicalOrder, current_building_index_for_evaluation]= negativeScore_PhysicalLimit
                print(f"current_building_index_for_evaluation_CC: {current_building_index_for_evaluation}")
                print(f"simulationObjective_costs_Euro_combined_CC: {simulationObjective_costs_Euro_combined}")
                print(f"result_multiple_buildings_simulationObjective_costs_Euro_CC {result_multiple_buildings_simulationObjective_costs_Euro_CC}")
                print(f"result_multiple_buildings_negativeScore_CorrectionLimit_CC {result_multiple_buildings_negativeScore_CorrectionLimit_CC}")
                print(f"result_multiple_buildings_negativeScore_PhysicalLimit_CC {result_multiple_buildings_negativeScore_PhysicalLimit_CC}")
                print(f"result_multiple_buildings_negativeScore_total_overall_CC {result_multiple_buildings_negativeScore_total_overall_CC}")
    ...
    # Create CSV result files for each building
    data = {
        ...
        "Euro_ANN": result_multiple_buildings_simulationObjective_costs_Euro_ML,
        "PhysicalLimit_ANN": result_multiple_buildings_negativeScore_PhysicalLimit_ML,
    }

    df = pd.DataFrame([dict(zip(data, row)) for row in zip(*data.values())])
    df = df.explode(df.columns.to_list())

    results_folder = folderPath_WholeSimulation +  "/Results"
    try:
        os.makedirs(results_folder)
    except OSError:
        print(f"Error creating the file {results_folder}")

    for idx, g in df.groupby(level=0):
        g = g.reset_index().rename(columns={"index": "Building"})
        g["Building"] = np.arange(1, len(g) + 1)
        mean = g.mean().to_frame().T.astype(float).round(2)
        mean["Building"] = "Averages"
        g = pd.concat([g, mean])
        g.to_csv(f"{results_folder}/Week{idx + 1}.csv", index=False, sep=";")
    ...
    with open(file_path_additional_information, "w") as file:
        ...
        file.write(f"Number of weeks for the evaluation: {number_of_weeks_for_evaluation}\n")
